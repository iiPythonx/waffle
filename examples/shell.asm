...
preload:
    clear:      .string "\033[2J\033[H"
    return:     .string "\033[2K\r"
    prompt:     .string "\033[32m$\033[0m "
    greeting:   .string "\nWelcome to \033[32mNocturne Shell\033[0m!\nCopyright (c) 2026 iiPython\n\n"
    goodbye:    .string "\n\033[31mGoodbye!\033[0m\n"
    no_cmd:     .string "\033[32mNocturne\033[0m: no such command exists!\n"
    version:    .string "\033[32mNocturne Shell\033[0m v0.3.0, powered by \033[34mwaffle\033[0m.\n"
    help_pre:   .string "Commands: "
    help_green: .string "\033[32m"
    help_reset: .string "\033[0m"
    strftime:   .string "%a %b %-d %H:%M:%S %p %Z %Y\n"
    mem1:       .string "Probing... "
    mem2:       .string "\rMemory usage: "
    mem3:       .string " B / 4096 B ("
    mem4:       .string "%)\n"
    reg1:       .string ": "
    reg2:       .string " | "
    memdump:    .string "Memory snapshot written to snapshot.bin!\n"
